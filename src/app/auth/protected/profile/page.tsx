...
export default async function Page({ searchParams }: { searchParams: { [key: string]: string | string[] | undefined } }) {
    ...
    return (
        <main className="min-h-screen w-full bg-white dark:bg-black text-white dark:text-gray-200">
            <div className="container mx-auto">
                <div className="h-ful w-full rounded flex p-4">
                    ...
                    <div className="h-full">
                        <p className="text-3xl">This section is under development</p>
                        <SignOut />
                    </div>
                </div>
            </div>
